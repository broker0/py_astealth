...
class StealthApi(ApiSpecification):
    ...
    # @ApiSpecification.method(7)
    # def SetEventProc(self, Eventname: TPacketEvent, Procname: String) -> None:
    #     pass
    ...
    # @ApiSpecification.method(137)
    # def GetIgnoreList(self, UserList: TStringList) -> Bool:
    #     pass
    #
    # @ApiSpecification.method(137)
    ...
    # def GetToolTipRec(self, ObjID: U32) -> ???:
    #     pass
    ...
    # @ApiSpecification.method(153)
    # def GetClilocByID(self, ClilocID: U32, Params: TArray<String>) -> String:
    #     pass
    ...
    # def GetContextMenu(self, list: TStringList) -> None:
    #     pass
    ...
    # @ApiSpecification.method(225)
    # def GetGumpTextLines(self, GumpIndex: U16, TL: TStringList) -> None:
    #     pass
    #
    # @ApiSpecification.method(225)
    # def GetGumpTextLines(self, GumpIndex: U16) -> ???:
    #     pass

    # @ApiSpecification.method(226)
    # def GetGumpFullLines(self, GumpIndex: U16, TL: TStringList) -> None:
    #     pass

    # @ApiSpecification.method(226)
    # def GetGumpFullLines(self, GumpIndex: U16) -> ???:
    #     pass

    # @ApiSpecification.method(227)
    # def GetGumpShortLines(self, GumpIndex: U16, TL: TStringList) -> None:
    #     pass
    #
    # @ApiSpecification.method(227)
    # def GetGumpShortLines(self, GumpIndex: U16) -> ???:
    #     pass
    #
    # @ApiSpecification.method(228)
    # def GetGumpButtonsDescription(self, GumpIndex: U16, TL: TStringList) -> None:
    #     pass
    #
    # @ApiSpecification.method(228)
    # def GetGumpButtonsDescription(self, GumpIndex: U16) -> ???:
    #     pass
    #
    # @ApiSpecification.method(229)
    # def GetGumpInfo(self, GumpIndex: U16, GumpInfo: TGumpInfo) -> None:
    #     pass
    #
    # @ApiSpecification.method(229)
    # def GetGumpInfo(self, GumpIndex: U16) -> ???:
    #     pass
    ...
    # def GetShopList(self, List: TStringList) -> None:
    #     pass
    #
    # @ApiSpecification.method(241)
    ...
    # def HTTP_Get(self, URL: String, LStream: TMemoryStream = nil) -> None:
    #     pass

    # @ApiSpecification.method(259)
    # def HTTP_Post(self, URL: String, PostData: TStringList) -> String:
    #     pass
    ...
    # def GetLandTileData(self, Tile: U16) -> ???:
    #     pass

    # @ApiSpecification.method(281)
    # def GetStaticTileData(self, Tile: U16) -> ???:
    #     pass
    ...
    # def ReadStaticsXY(self, X: U16, Y: U16, WorldNum: U8) -> ???:
    #     pass
    ...
    # @ApiSpecification.method(286)
    # def GetStaticTilesArray(self, Xmin: U16, Ymin: U16, Xmax: U16, Ymax: U16, WorldNum: U8, TileType: U16, FoundTilesArray: TFoundTilesArray) -> U16:
    #     pass

    # @ApiSpecification.method(286)
    # def GetStaticTilesArray(self, Xmin: U16, Ymin: U16, Xmax: U16, Ymax: U16, WorldNum: U8, TileType: U16) -> ???:
    #     pass

    # @ApiSpecification.method(287)
    # def GetLandTilesArray(self, Xmin: U16, Ymin: U16, Xmax: U16, Ymax: U16, WorldNum: U8, TileType: U16, LandTilesArray: TFoundTilesArray) -> U16:
    #     pass
    #
    # @ApiSpecification.method(287)
    # def GetLandTilesArray(self, Xmin: U16, Ymin: U16, Xmax: U16, Ymax: U16, WorldNum: U8, TileType: U16) -> ???:
    #     pass
    ...
    # def CloseClientUIWindow(self, UIWindowType: TUIWindowType, ID: U32) -> None:
    #     pass
    ...
    # def ClientTargetResponse(self) -> ???:
    #     pass

    # @ApiSpecification.method(300)
    # def GetQuestArrow(self, point: TPoint) -> Bool:
    #     pass
    ...
    @ApiSpecification.method(325)
    def StepQ(self, Direction: U8, Running: Bool) -> int:
        pass
    ...
    # @ApiSpecification.method(326)
    # def MoveXYZ(self, Xdst: U16, Ydst: U16, Zdst: I16, AccuracyXY: I32, AccuracyZ: I32, Running: Bool, StepCallback: TMoverStepCallBack = nil) -> Bool:
    #     pass
    ...
    # @ApiSpecification.method(327)
    # def MoveXY(self, Xdst: U16, Ydst: U16, Optimized: Bool, Accuracy: I32, Running: Bool, StepCallback: TMoverStepCallBack = nil) -> Bool:
    #     pass
    ...
    # def GetPathArray(self, Xdst: U16, Ydst: U16, Optimized: Bool, Accuracy: I32, PathArray: TPathArray) -> int:
    #     pass

    # @ApiSpecification.method(334)
    # def GetPathArray(self, Xdst: U16, Ydst: U16, Optimized: Bool, Accuracy: I32) -> ???:
    #     pass

    # @ApiSpecification.method(335)
    # def GetPathArray3D(self, StartX: U16, StartY: U16, StartZ: I16, FinishX: U16, FinishY: U16, FinishZ: I16, WorldNum: U8, AccuracyXY: I32, AccuracyZ: I32, Run: Bool, PathArray: TPathArray) -> int:
    #     pass
    #
    # @ApiSpecification.method(335)
    # def GetPathArray3D(self, StartX: U16, StartY: U16, StartZ: I16, FinishX: U16, FinishY: U16, FinishZ: I16, WorldNum: U8, AccuracyXY: I32, AccuracyZ: I32, Run: Bool) -> ???:
    #     pass

    # @ApiSpecification.method(338)
    # def GetMenuItems(self, Caption: String, TL: TStringList) -> None:
    #     pass

    # @ApiSpecification.method(338)
    # def GetMenuItems(self, Caption: String) -> ???:
    #     pass

    # @ApiSpecification.method(339)
    # def GetLastMenuItems(self, TL: TStringList) -> None:
    #     pass

    # @ApiSpecification.method(339)
    # def GetLastMenuItems(self) -> ???:
    #     pass

    # @ApiSpecification.method(340)
    # def FindTypesArrayEx(self, ObjTypes: TWordDynArray, Colors: TWordDynArray, Containers: TCardinalDynArray, InSub: Bool) -> U32:
    #     pass
    #
    # @ApiSpecification.method(340)
    # def FindTypesArrayEx(self, ObjTypes: array of Word, Colors: array of Word, Containers: array of Cardinal, InSub: Bool) -> U32:
    #     pass
    ...
    # @ApiSpecification.method(347)
    # def GetMultis(self, items: TMultiItems) -> U32:
    #     pass
    #
    # @ApiSpecification.method(347)
    # def GetMultis(self) -> ???:
    ...
    # def GetBuffBarInfo(self) -> ???:
    #     pass

    # @ApiSpecification.method(350)
    # def ConvertIntegerToFlags(self, group: U8, I: U32) -> ???:
    #     pass
    ...
    # def GetMenuItemsEx(self, Caption: String) -> ???:
    #     pass
    ...
    # def GlobalChatChannelsList(self, TL: TStringList) -> None:
    #     pass

    # @ApiSpecification.method(365)
    # def GlobalChatChannelsList(self) -> ???:
    #     pass

    @ApiSpecification.method(366)
    def GetNextStepZ(self, CurrX: U16, CurrY: U16, DestX: U16, DestY: U16, WorldNum: U8, CurrZ: I16) -> U8:
        pass
    ...
    def SkillLockState(self, SkillName: String, skillState: U8) -> None:
        pass
    ...
    # def GetMultiPartsAtPosition(self, X: U16, Y: U16) -> ???:
    #     pass
    #
    # @ApiSpecification.method(381)
    # def GetMultiAllParts(self, MultiID: U32) -> ???:
    #     pass
    ...
    # def AddUserStatic(self, StaticItem: TStaticItem, WorldNum: U8) -> int:
    #     pass
    ...
    # @ApiSpecification.method(387)
    # def StealthInfo(self) -> ???:
    #     pass

    # @ApiSpecification.method(388)
    # def GetMapCell(self, X: U16, Y: U16, WorldNum: U8) -> ???:
    #     pass
    ...
    # def GetScriptState(self, ScriptIndex: U16) -> ???:
    #     pass
    ...
    # def AddFigure(self, figure: TMapFigure) -> U32:
    #     pass
    ...
    # def UpdateFigure(self, FigureID: U32, figure: TMapFigure) -> Bool:
    #     pass
    ...
    #
    # @ApiSpecification.method(999)
    # def SetStatLockState(self, statNum: U8, statState: U8) -> None:
    #     pass
    #
    # @ApiSpecification.method(999)
