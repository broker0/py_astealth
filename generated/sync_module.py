...
def ChangeProfileEx(ProfileName: str, ShardName: str, CharName: str) -> int: pass
...
def GetStaticArtBitmap(ObjType: int, Hue: int) -> list[int]: pass
...
def GetStealthProfilePath() -> str: pass
...
def MaxMana() -> int: pass
def MaxPets() -> int: pass
def MaxStam() -> int: pass
